 ...
 { $name = $_POST['name'];
   ...
   else
   {
	   ...
	   {   $query = mysqli_query($link,"SELECT * FROM stud_info WHERE e_id='".$eid."'");
		    ...
		    if($row_cnt==0)
		    {
		   $query1 = mysqli_query($link,"insert into stud_info (s_name,gender,e_id,dob,address,phone,s_cred,s_sem,s_dep) values('".$name."','".$gender."','".$eid."','".$dob."','".$address."','".$phone."','".$s_cred."','".$s_sem."','".$sdept."')");
		    	//echo $row_cnt;
